 ...
 */
public class ChannelMarkTask extends AsyncTask<String, Void, List<Channel>> {
    private RssAction mAction;
    private Channel mChannel;
    private WeakReference<ChannelRecyclerViewAdapter> mContent;

    public ChannelMarkTask(Channel mChannel, RssAction mAction, ChannelRecyclerViewAdapter fragment){
