 ...
 */
public class FavListFragment extends BaseListFragment<Blog> {

    private BlogRecyclerViewAdapter mAdapter;
    private List<Blog> mBlogs;

    public static final FavListFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mBlogs = Blog.find(Blog.class, "IS_STARRED=1", null, "", "ACTION_TIME DESC", "30");
    ...
    public void onItemClick(View view, Blog data) {
        ...
        mBundle.putString("from", FromType.Starred.toString());
...
//        new PageTask(
//                Channel.getStarredChannel(PreferencesUtil.getProfile().getId()),
//                mBlogs,
//                mAdapter,
